...
class ZefyrThemeData {
  ...
  factory ZefyrThemeData.fallback(BuildContext context) {
    ...
    return ZefyrThemeData(
      ...
      color: TextStyle(color: Color(0xFF123153)), // MUDANÇA DO MIGUEL
      link: TextStyle(
  ...
  ZefyrThemeData copyWith({
    ...
    TextStyle color, // MUDANÇA DO MIGUEL
    TextStyle link,
    ...
    return ZefyrThemeData(
      ...
      color: color ?? this.color, // MUDANÇA DO MIGUEL
      link: link ?? this.link,
  ...
  ZefyrThemeData merge(ZefyrThemeData other) {
    return copyWith(
      ...
      color: other.color, // MUDANÇA DO MIGUEL
      link: other.link,
